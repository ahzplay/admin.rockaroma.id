    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            {{--<img src="{{ url('AdminLTE/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">--}}
            {{--<center><span class="brand-text font-weight-light">ROCKAROMA.ID</span></center>--}}
            <center><img class="brand-text font-weight-light" src="{{url('img/logo-rockaroma.png')}}"></center>
        </a>
