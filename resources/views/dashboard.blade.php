                                ...
                                <table id="slider-table" class="table table-striped">
                                    ...
                                    @foreach($raw as $key=>$val)
                                        <tr>
                                            ...
                                            <td>
                                                @if($val->is_active==1)
                                                    <button type="button" id="status-btn" onclick="updateStatus('{{$val->id}}','{{$val->is_active}}')" class="btn btn-success btn-xs">Active</button>
                                                @else
                                                    <button type="button" id="status-btn" onclick="updateStatus('{{$val->id}}','{{$val->is_active}}')" class="btn btn-default btn-xs">Not Active</button>
                                                @endif
                                            </td>
